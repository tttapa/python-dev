...
# User options
set(TOOLCHAIN_PYTHON_VERSION "3.11" CACHE STRING "Python version to locate")
set(TOOLCHAIN_PYPY_VERSION "7.3.20" CACHE STRING "PyPy version to locate")
...
function(toolchain_locate_python)
    ...
    if (NOT TOOLCHAIN_PYPY_VERSION MATCHES "^([0-9]+)\\.([0-9]+)(\\.[0-9]+)?$")
        message(SEND_ERROR "Invalid PyPy version. \${TOOLCHAIN_PYPY_VERSION} should be major.minor or major.minor.patch (e.g. 7.3.20)")
    endif()
    set(abi_version "${CMAKE_MATCH_1}${CMAKE_MATCH_2}")
    if (NOT TOOLCHAIN_PYTHON_VERSION MATCHES "^([0-9]+)\\.([0-9]+)$")
        message(SEND_ERROR "Invalid Python version. \${TOOLCHAIN_PYTHON_VERSION} should be major.minor (e.g. 3.11)")
    endif()
